# Risk-Free Rate Construction in Vietnam
...
: Comparison of Risk-Free Rate Proxies in Vietnam {#tbl-proxy-comparison}
...
It is instructive to compare Vietnam's risk-free rate environment with that of other emerging and developed markets to contextualize the magnitudes involved (@tbl-international-comparison).
...
: Risk-Free Rate Proxies: International Comparison {#tbl-international-comparison}
...
Based on the analysis in this chapter, we summarize the recommended practices for risk-free rate construction in Vietnamese financial research (@tbl-best-practices).
...
: Best Practices for Risk-Free Rate Construction {#tbl-best-practices}
