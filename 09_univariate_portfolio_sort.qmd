...
prices_monthly = (pd.read_sql_query(
    sql="SELECT permno, date, ret_excess, mktcap_lag FROM prices_monthly",
    con=tidy_finance,
    parse_dates={"date"})
)
...
beta_monthly = pd.read_sql_query(
  sql="SELECT permno, date, beta_monthly FROM beta WHERE return_type = 'monthly'",
  con=tidy_finance,
  parse_dates={"date"}
)
```
