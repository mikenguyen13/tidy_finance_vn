...
First, we retrieve the relevant data from our SQLite database introduced in [Accessing and Managing Financial Data](06_accessing_and_managing_financial_data.qmd) and [DataCore Data](07_datacore_data.qmd). Firm size is defined as market equity in most asset pricing applications that we retrieve from CRSP. We further use the Fama-French factor returns for performance evaluation.\index{Data!CRSP}\index{Data!Fama-French factors}
